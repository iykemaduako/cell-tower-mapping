# %% [markdown]
# # UNICEF
# ## cell detection by high-resolution satellite image classification
...
# img = Image.open(Path(base_path / "all" / "cell" / "17-36857-64877.jpg"))
# img = Image.open(Path(base_path / "all" / "cell" / "18-73792-129585.jpg"))
...
writer.add_text(
    f"Test_classif_report/all", parse_class_report(classif_report_dict, "no_cell")
)
writer.add_text(
    f"Test_classif_report/all", parse_class_report(classif_report_dict, "cell")
)
writer.add_text(
...
writer.add_text(
    f"Test_classif_report/urban", parse_class_report(classif_report_dict, "no_cell")
)
writer.add_text(
    f"Test_classif_report/urban", parse_class_report(classif_report_dict, "cell")
)
writer.add_text(
...
writer.add_text(
    ...
    parse_class_report(classif_report_dict, "no_cell"),
)
writer.add_text(
    f"Test_classif_report/not_urban", parse_class_report(classif_report_dict, "cell")
)
writer.add_text(
    f"Test_classif_report/not_urban",
    f"accuracy: {round(classif_report_dict.get('accuracy'), 3)}",

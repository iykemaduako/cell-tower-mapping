...
def load_trained_model(
    trained_model: str = "mobilenetv2",
    input_folder: str = "trained_models_output/",
):
    with open(
    ...
    if trained_model == "resnet18_aa":
    ...
    elif trained_model == "mobilenetv2":
        ...
        model = MobileNetV2ModelAntiAlias(n_classes=number_classes, pretrained=pretrained)
